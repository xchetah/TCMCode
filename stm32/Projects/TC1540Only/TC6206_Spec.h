#ifndef TC6206_SPEC_H
#define  TC6206_SPEC_H

//**************************************************************

#define ABSO_MODE_ACTIVE          //
#define SHOW_USEFUL4DEBUG_ONLY    //
#define PCB_TRINGLE_BOARD         //
...
//#define PARTIAL_ENABLE_SENSOR

//******************************************************************************************
// ===============================================================================
// S33-32-31-30,S29-28-27-26-25-24-23-22-21-20,S19-18-17-16-14,S8-7-6-5-4-3-2-1-0
// RX-VALID     = xxxx xx11 11;11 1111 1111; 1111 x1xx xx;x1 1111 1111 (x=0)
// RX Group     = "3210" ----------------> "2103"
// New RX-VALID = 11 1111 1111; 1111 x1xx xx;x1 1111 1111;xxxx xx11 11; (x=0)
//                1111 1111 1111 11x1 xxxx x111 1111 11xx xxxx 1111
//                f    f    f    d    0    7    f    c    0    f
//******************************************************************************************
#define RXCH_VALIDL      0xfd07fc0f  
#define RXCH_VALIDH      0xff        
...
#define FRAMEBUF_SIZE    28                              // 13X2 + 1 + 1 (for TC6206)
