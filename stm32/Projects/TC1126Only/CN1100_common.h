...
#ifdef FPCSCREEN_17X10
#include "ctp_FPCSCREEN_17X10.h"
#include "TxRxMap_TC1126s_TC960SB.h"
#endif

#ifdef SH_FEATUREPHONE_13X9
#include "ctp_SH_FEATUREPHONE_13X9.h"
#include "TxRxMap_TC1126s_TC1680SB.h"   // TC1688
#endif
...
#define FINGER_ADJUST_DISTANCE_MAX      72
 ...
 #ifdef STM32VC_LCD
  #define ISCANMODE_PERD_REG_VALUE             0x300   //20ms
  #define ISCANMODE_PERD_REG_VALUE_NORMAL      0x300   //22ms
  #define ISCANMODE_PERD_REG_VALUE_FINGER_ONLY 0x300   //18ms
 #else
  ...
  #define LCD_SCREEN_HIGH                      320
  #define LCD_SCREEN_WIDTH                     240
  #else
  #define LCD_SCREEN_HIGH                      800
...
#ifdef CN1100_STM32
#ifdef STM32VC_LCD
#define LCD_XMTR_SCALE  ((LCD_SCREEN_HIGH<<8)/SXMTR_NUM)   // Q8
#define LCD_RECV_SCALE  ((LCD_SCREEN_WIDTH<<8)/SRECV_NUM)   // Q8
#endif
#endif
