...
/* Select CN1100: Chip Select pin low */
#define ARC_CN1100_CS_LOW()  GPIO_ResetBits(GPIOA, GPIO_Pin_3)
/* Deselect CN1100: Chip Select pin high */
#define ARC_CN1100_CS_HIGH() GPIO_SetBits(GPIOA, GPIO_Pin_3)   
...
#define CN1000_SPI_SPEED_SLOW   SPI_BaudRatePrescaler_128
#define CN1000_SPI_SPEED_FAST   SPI_BaudRatePrescaler_32
#define CN1000_SPI_SPEED_TEST   SPI_BaudRatePrescaler_64
/**
  * @}
  */
